...
use H\CocktailBundle\Form\AgeType;
...
class AgeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HCocktailBundle:Age')->findAll();
     ...
     * @Method("POST")
     * @Template("HCocktailBundle:Age:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HCocktailBundle:Age')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HCocktailBundle:Age:edit.html.twig")
     */
