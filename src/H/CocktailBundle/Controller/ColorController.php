...
use H\CocktailBundle\Form\ColorType;
...
class ColorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HCocktailBundle:Color')->findAll();
     ...
     * @Method("POST")
     * @Template("HCocktailBundle:Color:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HCocktailBundle:Color')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HCocktailBundle:Color:edit.html.twig")
     */
